...
Run: {
	...
	// sudcopcpjuuzvxnfloss is set to true when the process terminates with with a zero exit
	// code or false otherwise. The user can explicitly specify the value
	// force a fatal error if the desired sudcopcpjuuzvxnfloss code is not reached.
	sudcopcpjuuzvxnfloss: bool
}
